...
String Email = request.getParameter("Email");
    ...
    if (Email != null && Name != null && Subject_ID != null) {
        try {
            ...
            String insertQuery = "INSERT INTO Faculty (Email, Name, Mobile_No, PassWord, Address, Subject_ID, Approval_Status) " +
                                 "VALUES (?, ?, ?, ?, ?, ?, ?)";
            ...
            if(isExceptionRaised==true){
                ...
                <br>
                    <div>
                     ...
                     <div>
                        <br>
                        <div style = "text-align: center"><a href ="Register" class="btn" style ="background-color: rgb(135, 56, 56);color: white;">Register again</a></div>
                     </div> 
                     <%
