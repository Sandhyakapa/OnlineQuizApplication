...
if (Email != null && Name != null && Subject_ID != null) {
try{
    //out.println("Email="+Email);
    Class.forName("com.mysql.cj.jdbc.Driver");
    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/onlinequizapp","root","Sandhya@123");
    String sql = "insert into student(Email, Name, Mobile_No, PassWord, Address, Subject_ID, Approval_Status) values(?,?,?,?,?,?,?)";
    ...
    ps.setInt(6, Integer.parseInt(Subject_ID));  // Insert selected Subject_ID as an integer
...
if(res>0){
    ...
    <div>
        <div style = "text-align: center"><a href ="Register.jsp" class="btn" style ="background-color: rgb(217, 78, 78);color: white;">Register again</a></div>
    </div> 
    <%
 }
...
<br>
    <div>
        <h5 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; text-align: center;">Student with email id: <%=Email%> already registered, Please register with another email id</h5>
     </div>
     <div>
        <br>
        <div style = "text-align: center"><a href ="Register.jsp" class="btn" style ="background-color: rgb(135, 56, 56);color: white;">Register again</a></div>
     </div> 
     <%
