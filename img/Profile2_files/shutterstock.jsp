			...
			try {
				...
				if (!usi_app.suppress_page) {
					if((usi_app.get_user_status("user").status == "guest" || usi_app.get_user_status("user").isActive == "false")) {
						...
						if (((/.shutterstock.com\/image-generated|.shutterstock.com\/ai-image-generator|.shutterstock.com\/generate|.shutterstock.com\/search\?image_type=generated/i).test(location.href) || checkout_ai_eligible) && (language_key == "_english")) {
