...
--
-- Host: localhost    Database: onlinequizapp
-- ------------------------------------------------------
...
CREATE TABLE `student_answers` (
  ...
  KEY `Selected_Option_idx` (`Selected_Option`),
  KEY `Quiz_id_idx` (`Quiz_id`),
  CONSTRAINT `Quiz_id_1` FOREIGN KEY (`Quiz_id`) REFERENCES `quiz` (`Quiz_id`),
  CONSTRAINT `Selected_Option` FOREIGN KEY (`Selected_Option`) REFERENCES `option` (`Option_id`),
...
-- Dump completed on 2024-07-08 19:25:08
