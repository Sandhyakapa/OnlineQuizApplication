...
try{
    ...
    String sql = "insert into admin(Email, Name, Mobile_No, PassWord, Address) values(?,?,?,?,?)";
...
<br>
    <div>
        <h5 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; text-align: center;">Admin with email id: <%=Email%> already registered, Please register with another email id</h5>
     </div>
     <div>
        <br>
